    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-emerald-100">
            ...
            <div class="bg-gradient-to-r from-emerald-500 to-cyan-500 px-6 py-4">
                <h3 class="text-xl font-bold text-white">Form Tambah Pasien</h3>
            </div>

            <!-- Form -->
            <form action="{{ route('pasien.store') }}" method="POST" class="p-6" id="formPasien">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div id="jenis_lainnya_container" style="display: none;">
                        ...
                        <input type="text" name="jenis_hewan_lainnya" id="jenis_hewan_lainnya" value="{{ old('jenis_hewan_lainnya') }}"
                               class="w-full px-4 py-2 border border-emerald-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="number" name="umur" value="{{ old('umur') }}" min="0"
                               class="w-full px-4 py-2 border border-emerald-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_check_in" value="{{ old('tanggal_check_in', date('Y-m-d')) }}"
                               class="w-full px-4 py-2 border border-emerald-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                               required>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_check_out" id="tanggal_check_out" value="{{ old('tanggal_check_out') }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_kematian" id="tanggal_kematian" value="{{ old('tanggal_kematian') }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed"
                               disabled>
                    ...
                    <div>
                        ...
                        <input type="number" name="biaya_perawatan" value="{{ old('biaya_perawatan', 0) }}" min="0" step="0.01"
                               class="w-full px-4 py-2 border border-emerald-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="diagnosa" rows="4"
                                  class="w-full px-4 py-2 border border-emerald-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                                  placeholder="Contoh: Demam tinggi, tidak mau makan, lemas..." required>{{ old('diagnosa') }}</textarea>
                        @error('diagnosa')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
